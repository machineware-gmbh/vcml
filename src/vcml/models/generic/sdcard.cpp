...
namespace vcml { namespace generic {
    ...
    void sdcard::make_r1(sd_command& tx) {
        ...
        m_status &= ~(OUT_OF_RANGE | ADDRESS_ERROR | BLOCK_LEN_ERROR |
                      ...
                      CSD_OVERWRITE | WP_ERASE_SKIP | ERASE_RESET |
                      AKE_SEQ_ERROR);
    }
    ...
    void sdcard::switch_function(u32 arg) {
        ...
        m_swf[ 0] = 0x00; m_swf[ 1] = 0x01; // max power */

        m_swf[ 2] = 0x00; m_swf[ 3] = 0x00; // supported grp6 functions
        m_swf[ 4] = 0x00; m_swf[ 5] = 0x00; // supported grp5 functions
        m_swf[ 6] = 0x00; m_swf[ 7] = 0x00; // supported grp4 functions
        m_swf[ 8] = 0x00; m_swf[ 9] = 0x00; // supported grp3 functions
        m_swf[10] = 0x00; m_swf[11] = 0x00; // supported grp2 functions
        m_swf[12] = 0x00; m_swf[13] = 0x00; // supported grp1 functions
