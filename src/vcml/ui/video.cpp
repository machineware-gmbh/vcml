...
namespace vcml { namespace ui {
    ...
    color_channel pixelformat_a(pixelformat fmt) {
        switch (fmt) {
        case FORMAT_A8R8G8B8: return { 24, 8 };
        case FORMAT_X8R8G8B8: return { 24, 0 };
        case FORMAT_R8G8B8A8: return {  0, 8 };
        case FORMAT_R8G8B8X8: return {  0, 0 };
        case FORMAT_A8B8G8R8: return { 24, 8 };
        case FORMAT_X8B8G8R8: return { 24, 0 };
        case FORMAT_B8G8R8A8: return {  0, 8 };
        case FORMAT_B8G8R8X8: return {  0, 0 };
        case FORMAT_R8G8B8:   return {  0, 0 };
        case FORMAT_B8G8R8:   return {  0, 0 };
        case FORMAT_R5G6B5:   return {  0, 0 };
        case FORMAT_B5G6R5:   return {  0, 0 };
        case FORMAT_GRAY8:    return {  0, 0 };
        default:
    ...
    color_channel pixelformat_r(pixelformat fmt) {
        switch (fmt) {
        case FORMAT_A8R8G8B8: return { 16, 8 };
        case FORMAT_X8R8G8B8: return { 16, 8 };
        case FORMAT_R8G8B8A8: return { 24, 8 };
        case FORMAT_R8G8B8X8: return { 24, 8 };
        case FORMAT_A8B8G8R8: return {  0, 8 };
        case FORMAT_X8B8G8R8: return {  0, 8 };
        case FORMAT_B8G8R8A8: return {  8, 8 };
        case FORMAT_B8G8R8X8: return {  8, 8 };
        case FORMAT_R8G8B8:   return { 16, 8 };
        case FORMAT_B8G8R8:   return {  0, 8 };
        case FORMAT_R5G6B5:   return { 11, 5 };
        case FORMAT_B5G6R5:   return {  0, 5 };
        case FORMAT_GRAY8:    return {  0, 8 };
        default:
            VCML_ERROR("invalid pixelformat: %u", (int)fmt);
        }
    }
    ...
    color_channel pixelformat_g(pixelformat fmt) {
        switch (fmt) {
        case FORMAT_A8R8G8B8: return {  8, 8 };
        case FORMAT_X8R8G8B8: return {  8, 8 };
        case FORMAT_R8G8B8A8: return { 16, 8 };
        case FORMAT_R8G8B8X8: return { 16, 8 };
        case FORMAT_A8B8G8R8: return {  8, 8 };
        case FORMAT_X8B8G8R8: return {  8, 8 };
        case FORMAT_B8G8R8A8: return { 16, 8 };
        case FORMAT_B8G8R8X8: return { 16, 8 };
        case FORMAT_R8G8B8:   return {  8, 8 };
        case FORMAT_B8G8R8:   return {  8, 8 };
        case FORMAT_R5G6B5:   return {  5, 6 };
        case FORMAT_B5G6R5:   return {  5, 6 };
        case FORMAT_GRAY8:    return {  0, 8 };
        default:
            VCML_ERROR("invalid pixelformat: %u", (int)fmt);
        }
    ...
    color_channel pixelformat_b(pixelformat fmt) {
        switch (fmt) {
        case FORMAT_A8R8G8B8: return {  0, 8 };
        case FORMAT_X8R8G8B8: return {  0, 8 };
        case FORMAT_R8G8B8A8: return {  8, 8 };
        case FORMAT_R8G8B8X8: return {  8, 8 };
        case FORMAT_A8B8G8R8: return { 16, 8 };
        case FORMAT_X8B8G8R8: return { 16, 8 };
        case FORMAT_B8G8R8A8: return { 24, 8 };
        case FORMAT_B8G8R8X8: return { 24, 8 };
        case FORMAT_R8G8B8:   return {  0, 8 };
        case FORMAT_B8G8R8:   return { 16, 8 };
        case FORMAT_R5G6B5:   return {  0, 5 };
        case FORMAT_B5G6R5:   return { 16, 5 };
        case FORMAT_GRAY8:    return {  0, 8 };
        default:
            VCML_ERROR("invalid pixelformat: %u", (int)fmt);
        }
