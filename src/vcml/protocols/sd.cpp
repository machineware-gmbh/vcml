...
void sd_base_initiator_socket::bind_socket(sc_object& obj) {
    using I = sd_base_initiator_socket;
    using T = sd_base_target_socket;
    bind_generic<I, T>(*this, obj);
}

void sd_base_initiator_socket::stub_socket(void* data) {
    stub();
}
...
void sd_base_target_socket::bind_socket(sc_object& obj) {
    using I = sd_base_initiator_socket;
    using T = sd_base_target_socket;
    bind_generic<I, T>(*this, obj);
}

void sd_base_target_socket::stub_socket(void* data) {
    stub();
}
