...
void eth_base_initiator_socket::bind_socket(sc_object& obj) {
    using I = eth_base_initiator_socket;
    using T = eth_base_target_socket;
    bind_generic<I, T>(*this, obj);
}

void eth_base_initiator_socket::stub_socket(void* data) {
    stub();
}
...
void eth_base_target_socket::bind_socket(sc_object& obj) {
    using I = eth_base_initiator_socket;
    using T = eth_base_target_socket;
    bind_generic<I, T>(*this, obj);
}

void eth_base_target_socket::stub_socket(void* data) {
    stub();
}
