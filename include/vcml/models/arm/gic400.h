...
public:
    ...
    gpio_target_array<NPPI * NCPU> ppi_in;
    gpio_target_array<NSPI> spi_in;

    gpio_initiator_array<NCPU> fiq_out;
    gpio_initiator_array<NCPU> irq_out;

    gpio_initiator_array<NVCPU> vfiq_out;
    gpio_initiator_array<NVCPU> virq_out;
