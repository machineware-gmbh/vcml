...
using mwr::bswap;
using mwr::memswap;
using mwr::le16_to_cpu;
using mwr::be16_to_cpu;
using mwr::le32_to_cpu;
using mwr::be32_to_cpu;
using mwr::le64_to_cpu;
using mwr::be64_to_cpu;
using mwr::cpu_to_le16;
using mwr::cpu_to_be16;
using mwr::cpu_to_le32;
using mwr::cpu_to_be32;
using mwr::cpu_to_le64;
using mwr::cpu_to_be64;
using mwr::crc7;
using mwr::crc16;
using mwr::crc32;
